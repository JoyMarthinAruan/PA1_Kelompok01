...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" id="semester" name="semester" value="<?php echo e(old('semester')); ?>"
            required>
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="mb-3">
        ...
        <select class="form-control" id="status" name="status" required>
            ...
            <option value="tidak" <?php echo e(old('status', 'aktif') == 'tidak' ? 'selected' : ''); ?>>Tidak Aktif</option>
        </select>
