...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="mb-3">
        ...
        <textarea class="form-control" id="institution_description" name="institution_description" rows="5"><?php echo e(old('institution_description')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="mb-3">
        ...
        <textarea class="form-control" id="company_profile" name="company_profile" rows="5"><?php echo e(old('company_profile')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="mb-3">
        ...
        <select class="form-control" id="is_active" name="is_active" required>
            ...
            <option value="0" <?php echo e(old('is_active', 1) == 0 ? 'selected' : ''); ?>>Tidak Aktif</option>
        </select>
