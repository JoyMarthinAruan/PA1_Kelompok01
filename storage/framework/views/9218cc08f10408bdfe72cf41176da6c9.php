...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="mb-3">
        ...
        <textarea class="form-control" id="description" name="description" rows="5" required><?php echo e(old('description', $achievement->description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" id="author" name="author"
            value="<?php echo e(old('author', $achievement->author)); ?>">
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="mb-3">
        ...
        <input type="date" class="form-control" id="date" name="date"
            value="<?php echo e(old('date', $achievement->date ? $achievement->date->format('Y-m-d') : '')); ?>">
